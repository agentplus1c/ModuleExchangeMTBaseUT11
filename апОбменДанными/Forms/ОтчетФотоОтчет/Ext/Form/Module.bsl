...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтррКонтекст.Вставить("Конфигурация"); //vd_190709 для сравнения версий УТ на сервере	
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	//((vd_190709
	//Было:
	//Если ИмяСобытия = ВариантыОтчетовКлиентСервер.ПолноеИмяПодсистемы() + ".ИзменениеВарианта" ИЛИ ИмяСобытия = "Запись_НаборКонстант" Тогда 
...
//vd_190709 Добавлена. Типовой функционал ОтчетыКлиент.ВыбратьПериод
&НаКлиенте 
...
Процедура БыстрыеНастройкиСоздатьЭлементыУправленияИЗагрузитьЗначения(ПараметрыЗаполнения, Информация)
	...
	ТекОбъект = РеквизитФормыВЗначение("Отчет"); //vd_190709
...
//vd_190709 Добавлена. Типовой функционал ОтчетыСервер.ВывестиЭлементыНастройки 
&НаСервере
...
//vd_190709 Добавлена. Типовой функционал ОтчетыСервер.ВывестиПоПорядку 
&НаСервере
